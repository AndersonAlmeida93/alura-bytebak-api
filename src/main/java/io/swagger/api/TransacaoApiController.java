...
,@ApiParam(value = "" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization
    ...
    public ResponseEntity<Transacao> cadastraTransao(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Transacao body
,@ApiParam(value = "" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization
